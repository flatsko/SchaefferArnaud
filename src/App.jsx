        ...
        <Router>
          <div className="min-h-screen bg-white">
            ...
            <Routes>
              ...
              <Route path="/services/web-development" element={<DeveloppementWeb />} />
              <Route path="/services/hosting-maintenance" element={<HebergementMaintenance />} />
              <Route path="/services/seo" element={<SeoReferencement />} />
